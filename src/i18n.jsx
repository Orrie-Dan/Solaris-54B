...
export const translations = {
  en: {
    nav: {
      ...
      viewAllSsit: "SSIT Platform",
      viewAllMarkets: "All Markets",
      why: "Why Solaris 54",
      approach: "Approach",
      group: "Group",
      contact: "Contact",
    ...
    common: {
      ...
      discussThisProduct: "Discuss This Product",
      ...
      moreInThisRange: "More in this range",
      catalogCtaTitle: "Plan your rural electrification programme",
      catalogCtaLead: "Speak with our team about PayGo deployment, product selection, and national-scale rollout.",
      tier: "Tier",
  ...
  fr: {
    nav: {
      ...
      ssit: "SSIT",
      markets: "Marches",
      viewAllSolutions: "Toutes les solutions",
      viewAllSsit: "Plateforme SSIT",
      viewAllMarkets: "Tous les marches",
    ...
    common: {
      ...
      viewProductDetails: "Voir les détails",
      backToSolution: "Retour à la solution",
      productNotFound: "Produit introuvable",
      discussThisProduct: "Discuter de ce produit",
      solutionOverview: "Aperçu de la solution",
      whatWeDeliver: "Ce que nous offrons",
      impact: "Impact",
      problemsWeSolve: "Problèmes que nous résolvons",
      ourProductRange: "Notre gamme de produits",
      relatedProducts: "Produits associés",
      moreInThisRange: "Plus dans cette gamme",
      catalogCtaTitle: "Planifiez votre programme d'électrification rurale",
      catalogCtaLead: "Échangez avec notre équipe sur le déploiement PayGo, le choix des produits et le déploiement à l'échelle nationale.",
      tier: "Niveau",
